...
export const BEFORE_AFTER_DATA: BeforeAfterItem[] = [
  {
    ...
    beforeImg: '/images/before-fruit-CzWcVnOE.png',
    afterImg: '/images/after-fruit-D1an2U3e.jpg',
  ...
  },
  {
    ...
    label: 'Loja & Produtos',
    beforeImg: '/images/before-lingerie-D0bOVO6Z.jpg',
    afterImg: '/images/after-lingerie-BwfVXGKj.jpg',
  ...
  },
  {
    ...
    beforeImg: '/images/before-gym-DfFcG8W2.png',
    afterImg: '/images/after-gym-Cdqt_dYD.jpg',
  ...
  },
  {
    ...
    beforeImg: '/images/before-netflix-D9J760Rd.png',
    afterImg: '/images/after-netflix-CWmTPNHb.jpg',
  ...
  },
  {
    ...
    label: 'Musa Fitness',
    beforeImg: '/images/before-fitness-DZyd-cF-.png',
    afterImg: '/images/after-fitness-DC_K6b53.jpg',
...
export const STICKER_ITEMS: StickerItem[] = [
  { id: 1, name: 'Pipoca & Dorama', img: '/images/sticker-1-CUhZcYaj.png', category: 'Entretenimento' },
  { id: 2, name: 'Frase Motivacional', img: '/images/sticker-2-CtHK1tkb.png', category: 'Frases' },
  { id: 3, name: 'Momento Café', img: '/images/sticker-3-CYa_b6Hg.png', category: 'Rotina' },
  { id: 4, name: 'Horário & Alerta', img: '/images/sticker-4-Bz4LTYqM.png', category: 'Comercial' },
  { id: 5, name: 'Feedback de Cliente', img: '/images/sticker-5-DjomY0fN.png', category: 'Negócios' },
  { id: 6, name: 'Coração Minimalista', img: '/images/sticker-6-BPiw3Ak_.png', category: 'Estética' },
  { id: 8, name: 'Sextou Relax', img: '/images/sticker-8-BFD-NdQg.png', category: 'Final de Semana' },
  { id: 9, name: 'Treino Pago', img: '/images/sticker-9-SLEOzQQo.png', category: 'Fitness' },
  { id: 10, name: 'Foco & Produtividade', img: '/images/sticker-10-DfvINmaU.png', category: 'Trabalho' },
  { id: 11, name: 'Detalhe Floral', img: '/images/sticker-11-BliCkY5X.png', category: 'Delicado' },
  { id: 12, name: 'Loja Aberta', img: '/images/sticker-12-C68Rt-ns.png', category: 'Vendas' },
  { id: 13, name: 'Bom Dia & Fé', img: '/images/sticker-13-BnuPCZTi.png', category: 'Inspiração' },
  { id: 14, name: 'Moldura Polaróide', img: '/images/sticker-14-TzpsTBd9.png', category: 'Molduras' },
  { id: 15, name: 'Glow Minimalista', img: '/images/sticker-15-CKHRMzGh.png', category: 'Brilhos' },
  { id: 16, name: 'Divisor Estético', img: '/images/sticker-16-D0e3fNl6.png', category: 'Traços' },
  { id: 17, name: 'Aviso Importante', img: '/images/sticker-17-JjG14PVt.png', category: 'Recados' },
  { id: 18, name: 'Lifestyle Chic', img: '/images/sticker-18-BI5dxiw-.png', category: 'Moda' },
  { id: 19, name: 'Checklist Diário', img: '/images/sticker-19-DSx-dlyZ.png', category: 'Produtividade' },
];
...
export const STORIES_GALLERY: StoryItem[] = [
  { id: 1, img: '/images/story-1-C665SIao.jpg', tag: 'Café', title: 'Rotina Matinal com Café' },
  { id: 2, img: '/images/story-2-B94qPte1.jpg', tag: 'Rotina', title: 'Home Office Produtivo' },
  { id: 3, img: '/images/story-3-CCcShyHH.jpg', tag: 'Academia', title: 'Treino & Disciplina' },
  { id: 4, img: '/images/story-4-CNnDSkV9.jpg', tag: 'Trabalho', title: 'Reunião & Metas' },
  { id: 5, img: '/images/story-5-DN4tThc0.jpg', tag: 'Viagem', title: 'Pôr do Sol na Praia' },
  { id: 6, img: '/images/story-6-BqgU9-pI.jpg', tag: 'Fé', title: 'Momento de Gratidão' },
  { id: 7, img: '/images/story-7-BNw7-3Kq.jpg', tag: 'Beleza', title: 'Cuidados com a Pele' },
  { id: 8, img: '/images/story-8-D6MxRHTs.jpg', tag: 'Lifestyle', title: 'Almoço Saudável' },
  { id: 9, img: '/images/story-9-Cqu-C6DV.jpg', tag: 'Empreendedorismo', title: 'Envio de Pedidos' },
  { id: 10, img: '/images/story-10-B3zch44O.jpg', tag: 'Café', title: 'Pausa para o Cappuccino' },
  { id: 11, img: '/images/story-11-_8e1j99H.jpg', tag: 'Rotina', title: 'Organização da Semana' },
  { id: 12, img: '/images/story-12-BH_IGoOa.jpg', tag: 'Viagem', title: 'Fim de Tarde Relax' },
  { id: 13, img: '/images/story-13-B676D-DK.jpg', tag: 'Beleza', title: 'Look do Dia Elegante' },
  { id: 14, img: '/images/story-14-_BhRRc8t.jpg', tag: 'Lifestyle', title: 'Noite de Cinema' },
  { id: 15, img: '/images/story-15-CDB78I5r.jpg', tag: 'Maternidade', title: 'Amor & Afeto' },
  { id: 16, img: '/images/story-16-CD4pJhPo.jpg', tag: 'Fé', title: 'Palavra de Conforto' },
  { id: 17, img: '/images/story-17-D25O698I.jpg', tag: 'Academia', title: 'Meta Batida' },
  { id: 18, img: '/images/story-18-CKJXJhhx.jpg', tag: 'Trabalho', title: 'Novidades na Loja' },
];
