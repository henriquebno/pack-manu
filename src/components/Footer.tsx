...
export const Footer: React.FC<FooterProps> = ({ onOpenLegal }) => {
  return (
    <footer className="bg-[#181414] text-neutral-300 py-12 px-4 sm:px-6 border-t border-white/5">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center space-y-6">
        ...
        {/* Disclaimer */}
        <p className="text-[11px] text-neutral-300 max-w-2xl leading-relaxed">
        ...
        {/* Copyright */}
        <div className="pt-6 border-t border-white/10 w-full flex flex-col sm:flex-row items-center justify-between text-xs text-neutral-300 gap-2">
