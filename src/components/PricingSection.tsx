  ...
  return (
    <section id="planos" className="py-14 md:py-24 bg-[#FBF9F6] relative border-t border-neutral-200/60">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        {/* Pricing Cards Grid - 19,90 FIRST, 37,90 SECOND */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-start">
          
          {/* PLAN 1: PACK ESSENCIAL - R$ 19,90 (FIRST) */}
          <div className="md:col-span-5 bg-white rounded-3xl p-5 sm:p-7 border border-neutral-200/80 shadow-sm flex flex-col justify-between relative order-1">
            <div>
              ...
              <div className="mb-5">
                ...
                <div className="flex items-baseline gap-1 mt-0.5">
                  ...
                  <span className="text-3xl sm:text-4xl font-bold text-[#1D1D1F] font-heading tracking-tight">19,90</span>
                </div>
                <p className="text-[11px] text-neutral-500 mt-1 font-sans-body">Acesso vitalício • Sem mensalidades</p>
              </div>

              {/* Features List */}
              <div className="space-y-2.5 mb-6 text-xs sm:text-sm text-neutral-700 font-sans-body">
          ...
          {/* PLAN 2: PACK COMPLETO - R$ 37,90 (SECOND, NO TEXT CUT OFF) */}
          <div className="md:col-span-7 bg-white rounded-3xl p-5 sm:p-7 border-2 border-rose-500/90 shadow-lg shadow-rose-950/5 flex flex-col justify-between relative order-2 overflow-hidden">
            
            {/* Clean Top Full-Width Banner Pill */}
            <div className="bg-gradient-to-r from-rose-500 to-pink-600 text-white text-[11px] font-bold py-1.5 px-4 rounded-xl uppercase tracking-wider flex items-center justify-center gap-1.5 mb-4 shadow-xs font-heading">
              <Star className="w-3.5 h-3.5 fill-current" />
              <span>MAIS ESCOLHIDO (96% DAS MULHERES)</span>
            </div>

            <div>
              {/* Header Info with ample breathing space */}
              <div className="mb-4 pb-4 border-b border-rose-100">
                ...
                <p className="text-xs text-neutral-600 mt-1 font-sans-body">
                  Leve a coleção completa de figurinhas, molduras, divisores e todos os 4 bônus especiais.
                </p>
              </div>

              {/* Price comparison */}
              <div className="mb-4 bg-rose-50/60 rounded-2xl p-3.5 border border-rose-100">
                ...
                <div className="flex items-baseline gap-1 mt-0.5">
                  ...
                  <span className="text-4xl sm:text-5xl font-bold text-rose-600 font-heading tracking-tight">37,90</span>
                </div>
              ...
              {/* Features List */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4 text-xs text-neutral-700 font-sans-body">
              ...
              <div className="bg-gradient-to-r from-rose-50 to-pink-50 rounded-2xl p-3.5 border border-rose-100 mb-5">
                <div className="flex items-center justify-between gap-2 mb-2">
                  <span className="text-[11px] font-bold text-rose-900 uppercase tracking-wider flex items-center gap-1 font-heading">
                ...
                <ul className="space-y-1 text-xs text-neutral-800 font-sans-body">
                  <li className="flex items-center gap-1.5">
                    <span className="text-rose-500 font-bold">•</span>
                    <span><strong>Bônus 1:</strong> Biblioteca de Fontes Exclusivas</span>
                  </li>
                  <li className="flex items-center gap-1.5">
                    <span className="text-rose-500 font-bold">•</span>
                    <span><strong>Bônus 2:</strong> Guia de Stories & Combinações</span>
                  </li>
                  <li className="flex items-center gap-1.5">
                    <span className="text-rose-500 font-bold">•</span>
                    <span><strong>Bônus 3:</strong> +100 Fundos Premium para Stories</span>
                  </li>
                  <li className="flex items-center gap-1.5">
                    <span className="text-rose-500 font-bold">•</span>
                    <span><strong>Bônus 4:</strong> Coleção de Figurinhas 3D Exclusivas</span>
                  </li>
                </ul>
              </div>
            </div>
